...
sonarqube {
    properties {
        ...
        property("sonar.java.binaries", "app/build/intermediates/compile_app_classes_jar/debug/bundleDebugClassesToCompileJar/classes.jar,appupdater/build/intermediates/compile_library_classes_jar/debug/bundleLibCompileToJarDebug/classes.jar")
    }
}
